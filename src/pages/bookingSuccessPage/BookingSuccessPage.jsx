...
import './BookingSuccessPage.scss';
            ...
            <div className="detail-section">
              ...
              <div className="detail-grid">
                ...
                <div className="detail-item">
                  ...
                  <span className="value">{vehicle?.make} {vehicle?.model}</span>
                </div>
              </div>
            </div>
        ...
        <div className="action-buttons">
          <button className="btn-home" onClick={handleGoHome}>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path d="M3 10l7-7 7 7M5 10v8h10v-8" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
            </svg>
            Về trang chủ
          </button>
          <button className="btn-start-charging" onClick={handleStartCharging}>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path d="M11 3L6 10h8l-5 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            Tiến hành sạc
          </button>
        </div>
